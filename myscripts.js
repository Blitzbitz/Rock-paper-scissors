...
function getHumanChoice(){
    ...
    }else if(humanChoice.toLowerCase() === ("rock")){console.log("Rock");rock = 0;

    }else if (humanChoice.toLowerCase() === ("paper")){console.log("Paper"); paper = 1;
    
    }else if (humanChoice.toLowerCase() === ("scissors")){console.log("Scissors"); scissors = 2 ;
